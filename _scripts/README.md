...
UndertaleModTool scripts. Go to scripts and run a custom one.
This folder currently stores the following scripts.
...
Export scripts will ask you to specify a folder to save the respective data into.
It's not a file. Just save it in the folder it asks you.
